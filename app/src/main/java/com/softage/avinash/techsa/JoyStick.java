...
/**
 * Created by Avinash on 3/16/2018.
 */
...
public class JoyStick extends AppCompatActivity {
    ...
    Button forward_btn, forward_left_btn, forward_right_btn, reverse_btn, stop_btn, reverse_right_btn, bluetooth_connect_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(MainActivity.getMacAddress().toString());
        bluetooth_connect_btn.callOnClick();
    ...
    public boolean BTinit() {
        ...
        if (bondedDevices.isEmpty()) //Checks for paired bluetooth devices
        {
            ...
            for (BluetoothDevice iterator : bondedDevices) {
                if (iterator.getAddress().equals(MainActivity.getMacAddress())) {
                    device = iterator;
                    found = true;
                    break;
                }
